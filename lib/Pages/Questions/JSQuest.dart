...
class JSQuest extends StatefulWidget {
  const JSQuest({super.key});
  @override
  State<JSQuest> createState() => _JSQuestState();
}

class _JSQuestState extends State<JSQuest> {
  List<Map> allQuestions = [
    ...
    },
    {
      ...
      "options": ["a) var x;", "b) int x;", "c) variable x;", "d) let x;"],
      "answerIndex": 3
    },
    {
      "Question":
          "Q3.Which function is used to print content to the console in JavaScript?",
      "options": ["a) console.log()", "b) print()", "c) log()", "d) write()"],
      "answerIndex": 0
    },
    {
      "Question": "Q4.What does NaN stand for in JavaScript?",
      "options": [
        "a) Not a Null",
        "b) Not a Number",
        "c) New and Null",
    ...
    {
      "Question": "Q5.What keyword is used to define a function in JavaScript?",
    ...
    if (questionScreen == true) {
      return Scaffold(
          ...
          body: Column(
            ...
            children: [
              const SizedBox(height: 40),
              const Text("JavaScript Questions",
